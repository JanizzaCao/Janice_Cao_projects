# Janice Cao Projects
    ...
    本人数据科学学习内容分享公众号：数据科学之路 欢迎关注  
    
<img src="公众号QRcode8cm.jpg" width="50%" align="middle">
...
|日期|内容|
|:-:|:-|
|2020.4.26|《电商数据分析与数据化运营》笔记更新公众号文章链接|
|2020.4.19|新增公众号说明|
|2020.4.16|SQL重要概念补全，内容参考：https://mp.weixin.qq.com/s/LGfE29ch1xsHb2bNhdVPCQ|
|2020.4.12|增加SQL求最大连续日期的新解法|
...
|2020.04.1|1. SQL窗口函数题目更新（含mysql变量解决问题） <br> 2. [增加主要知识点、问题梳理](https://shimo.im/docs/yxTCRKGqdwGCkgKW/) <br> 3. 本日完成阅读《电商数据分析与数据化运营》，内容对业务理解很有帮助，继续重读增加笔记|  
